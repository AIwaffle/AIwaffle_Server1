...
| author\_uuid | string              | The uuid of the author |
...
| Name          | Format | Description                  |
|---------------+--------+------------------------------|
| session\_id   | string | The id of the model session  |
| learning\_rate | float  | The learning rate (optional) |
**** Response
| Name     | Format      | Description                                          |
|----------+-------------+------------------------------------------------------|
...
| avg\_loss | float       | The average loss                                     |
